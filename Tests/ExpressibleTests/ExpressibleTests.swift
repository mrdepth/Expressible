...
final class ExpressibleTests: XCTestCase {
    ...
    static var bundle: Bundle = {
        let bundle = Bundle(for: ExpressibleTests.self)
        if let url = bundle.url(forResource: "Expressible_ExpressibleTests", withExtension: "bundle") {
    ...
    static var persistentContainer: NSPersistentContainer = {
        let model = NSManagedObjectModel(contentsOf: ExpressibleTests.bundle.url(forResource: "Example", withExtension: "momd")!)!
    ...
    static func seed(viewContext: NSManagedObjectContext) {
        ...
        let s = try! String(contentsOf: ExpressibleTests.bundle.url(forResource: "worldcities", withExtension: "csv")!)
